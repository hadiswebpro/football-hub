function createHeader() {
    ...
    header.innerHTML = `
        <div class="header__container">
            ...
            <div class="header__search-dropdown" id="searchDropdown"><input type="search" id="mobileSearchInput" placeholder="Search teams, leagues..." autocomplete="off"></div>
        </div>`;
    ...
    const updateActiveNav = () => {
        ...
        const activeRoute = ["#team", "#teams"].includes(hash) ? "teams" : hash === "#matches" ? "matches" : hash === "#league" ? "leagues" : "home";
