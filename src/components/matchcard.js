...
function createMatchCard(match) {
    ...
    card.innerHTML = `
        <div class="match-card__topline">
            ...
            <span class="match-card__status"><i></i>${match.status === "LIVE" ? match.minute : match.status}</span>
        </div>
        <div class="match-card__teams">
            <div class="match-card__team"><div class="match-card__logo-wrap"><img src="${match.home.logo}" alt="${match.home.name} logo"></div><strong>${match.home.name}</strong></div>
